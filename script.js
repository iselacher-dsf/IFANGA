$(document).ready(function(){
  ...
  var config = {
    apiKey: "AIzaSyBG5KKwyCsmAnqFdZSWPFCAsIi5oY-d-x4",
    authDomain: "ifangadatabase.firebaseapp.com",
    databaseURL: "https://ifangadatabase.firebaseio.com",
    projectId: "ifangadatabase",
    storageBucket: "ifangadatabase.appspot.com",
    messagingSenderId: "855397616487"
  };
    ...
    if( $('#loginEmail').val() != '' && $('#loginPassword').val() != '' ){
      ...
      firebase.auth().signInWithEmailAndPassword(data.email, data.password)
        .then(function(authData) {
          ...
          setTimeout(function () {
            $('#messageModal').modal('hide');
            window.open("https://iselacher-dsf.github.io/IFANGA/Dashboard.html","_self");
